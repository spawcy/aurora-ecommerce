  ...
  return (
    <div className="h-screen flex flex-col items-center justify-center">
      <div className="text-center max-w-md 2xl:max-w-2xl mx-auto">
        ...
        <p className="text-muted-foreground mt-1 2xl:text-xl 2xl:mt-3.5  leading-relaxed">he product you are looking for might have been moved, sold out, or the link you followed is incorrect.</p>
      </div>
    </div>
  );
}
